        ...
        <div className="container position-relative z-3">
          <div className="row">
            <div className="col-lg-6 col-md-12">
              ...
              <p className="text-300 mb-6">I assist individuals and brands in achieving their objectives by creating and developing amazing websites.</p>
              ...
              <p className="text-400 mt-6 mb-3">+ 4 years of professional experience</p>
